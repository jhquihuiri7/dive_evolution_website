...
const Tour: FunctionComponent<TourProps> = ({ title, description, price, imageUrl }) => {
  ...
  return (
    <div
      ...
      className={`h-fit w-[300px] rounded-xl overflow-hidden shadow-lg flex flex-col justify-center items-center m-10 transition-all duration-500 ease-in-out transform ${
