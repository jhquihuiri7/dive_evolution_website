...
const Highlight: React.FC<SectionProps> = ({ refProp }) => {
  return (
    <div
      ref={refProp}
      className={`relative flex flex-col justify-center items-center w-full h-screen shadow-inner-lg bg-[url("https://res.cloudinary.com/logicielapplab/image/upload/v1739073504/DIVE_EVOLUTION_2025/DESTACADOS/BACKGROUND/destacados_nuc9kn.webp")] bg-cover bg-center`}
    >
